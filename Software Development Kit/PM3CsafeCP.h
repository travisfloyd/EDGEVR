...
/****************************************************************************
   tkcmdsetCSAFE_set_language_type

   About:      Set the language type on the erg.

   Inputs:     UINT16_T    unit_address
               UINT8_T     Language Type
...
****************************************************************************/
PM3CSAFE_API ERRCODE_T tkcmdsetCSAFE_set_language_type(UINT16_T unit_address,
   UINT8_T language);

/****************************************************************************
   tkcmdsetCSAFE_get_language_type

   About:      Get the language type from the erg.

   Inputs:     UINT16_T    unit_address
               UINT8_T     *Language Type

   Outputs:    Saves language type

   Returns:    ERRCODE_T   ecode				Zero if successful
														Error code otherwise

****************************************************************************/
PM3CSAFE_API ERRCODE_T tkcmdsetCSAFE_get_language_type(UINT16_T unit_address,
   UINT8_T *language);
