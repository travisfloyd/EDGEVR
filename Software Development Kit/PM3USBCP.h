...
#define TKCMDSET_PM3_PM4_PRODUCT_NAME        "Concept2 Performance Monitor"
...
/****************************************************************************
   tkcmdsetUSB_register_events2

   About:      Register a callback for device connect/disconnect events.
               Callback has 2 additional parameters from the other register function.
...
****************************************************************************/
PM3USB_API ERRCODE_T tkcmdsetUSB_register_events2(MPDEVENT_PROC callback);

/****************************************************************************
   tkcmdsetUSB_unregister_events2
...
****************************************************************************/
PM3USB_API ERRCODE_T tkcmdsetUSB_unregister_events2();
...
PM3USB_API ERRCODE_T tkcmdsetUSB_send_command(UINT16_T port, UINT8_T *tx_ptr, 
                                 UINT16_T tx_len, UINT16_T rx_len, UINT16_T cmd_tag);
 ...
 ****************************************************************************/
PM3USB_API ERRCODE_T tkcmdsetUSB_get_buffer_mode(UINT16_T port, UINT8_T *mode);
...
/****************************************************************************
 tkcmdsetUSB_write_spiflashblk8
 ...
 ****************************************************************************/
PM3USB_API ERRCODE_T tkcmdsetUSB_write_spiflashblk8(UINT16_T port, UINT32_T address, UINT8_T * val_ptr8,
                                                    UINT32_T len, UINT16_T *packet_rsp_len);

/****************************************************************************
 tkcmdsetUSB_read_spiflashblk8
 
 About:     Reads an 8-bit block of data from a SPI FLASH memory location
            This implementation supports only 1 block read at at time
            (depends on TKUSB_MAX_PACKET_SIZE)
 ...
 ****************************************************************************/
PM3USB_API ERRCODE_T tkcmdsetUSB_read_spiflashblk8(UINT16_T port, UINT32_T address, UINT8_T *val_ptr8,
                                                   UINT32_T len, UINT16_T *packet_rsp_len);

/****************************************************************************
 tkcmdsetUSB_get_image_crc
 ...
 ****************************************************************************/
PM3USB_API ERRCODE_T tkcmdsetUSB_get_image_crc(UINT16_T port, UINT32_T address, UINT32_T *val_ptr32,
                                               UINT32_T len, UINT16_T *packet_rsp_len);

/****************************************************************************
 tkcmdsetUSB_get_update_status
 ...
 Outputs:   UINT16_T *   val_ptr         Location to store update info (2 UINT16_T's)
 ...
 ****************************************************************************/
PM3USB_API ERRCODE_T tkcmdsetUSB_get_update_status(UINT16_T port, UINT16_T *val_ptr16,
